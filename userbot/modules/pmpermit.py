...
DEF_UNAPPROVED_MSG = (
    "╔═════════════════════╗\n"
    "   𝗪 𝗘 𝗟 𝗖 𝗢 𝗠 𝗘   𝗣 𝗘 𝗦 𝗔 𝗡    ”\n"
    "╚═════════════════════╝\n"
    "**ᴛᴏʟᴏɴɢ ᴊᴀɴɢᴀɴ ᴍᴇʟᴀᴋᴜᴋᴀɴ sᴘᴀᴍ ᴄʜᴀᴛ ᴋᴇᴘᴀᴅᴀ ʙᴏs sᴀʏᴀ** \n"
    f"**ᴋᴀʀᴇɴᴀ sᴀʏᴀ ᴀᴋᴀɴ ᴍᴇᴍʙʟᴏᴋɪʀ ᴋᴀᴍᴜ, ᴛᴜɴɢɢᴜ {ALIVE_NAME} ᴍᴇɴᴇʀɪᴍᴀ ᴘᴇsᴀɴ ᴋᴀᴍᴜ** \n"
    "╔═════════════════════╗\n"
    "│○›ᴘᴇsᴀɴ ᴏᴛᴏᴍᴀᴛɪs           \n"
    f"│○›ʙʏ xᴀ ᴜsᴇʀʙᴏᴛ           \n"
    "╚═════════════════════╝")
    ...
    if (
        ...
        if not apprv and event.text != UNAPPROVED_MSG:
            ...
            if COUNT_PM[event.chat_id] > 5:
                await event.respond(
                    "`ᴀɴᴅᴀ ᴛᴇʟᴀʜ ᴅɪ ʙʟᴏᴋɪʀ ᴋᴀʀᴇɴᴀ ᴍᴇʟᴀᴋᴜᴋᴀɴ sᴘᴀᴍ ᴘᴇsᴀɴ`\n"
                    f"`ᴋᴇ ʀᴏᴏᴍ ᴄʜᴀᴛ ɪɴɪ`"
                )
...
async def approvepm(apprvpm):
    ...
    try:
        ...
        return await apprvpm.edit("`ᴏᴋᴇ ᴘᴇsᴀɴ ᴀɴᴅᴀ sᴜᴅᴀʜ ᴅɪᴛᴇʀɪᴍᴀ`")
