...
async def upstream(event):
    ...
    if force_update:
        ...
        await xx.edit("` Proses Update ⚡xᴀ-ᴜsᴇʀʙᴏᴛ⚡, Loading....1%`")
        await xx.edit("` Proses Update ⚡xᴀ-ᴜsᴇʀʙᴏᴛ⚡ Loading....20%`")
        await xx.edit("` Proses Update ⚡xᴀ-ᴜsᴇʀʙᴏᴛ⚡, Loading....35%`")
        await xx.edit("` Proses Update ⚡xᴀ-ᴜsᴇʀʙᴏᴛ⚡, Loading....77%`")
        await xx.edit("` Proses Update ⚡xᴀ-ᴜsᴇʀʙᴏᴛ⚡, Updating...90%`")
        await xx.edit(
            "` Proses Update ⚡xᴀ-ᴜsᴇʀʙᴏт⚡, Mohon Tunggu Sebentar....100%`"
        )
...
CMD_HELP.update(
    {
        ...
        "\n• : Untuk Melihat Pembaruan Terbaru Xa-Userbot."
        f"\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}update now`"
        "\n• : Memperbarui Xa-Userbot."
        f"\n\n𝘾𝙤𝙢𝙢𝙖𝙣𝙙: `{cmd}update deploy`"
        "\n• : Memperbarui Xa-Userbot Dengan Cara Men-Deploy Ulang."
    }
)
