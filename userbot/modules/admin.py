...
async def rm_deletedacc(show):
    ...
    if con != "clean":
        await show.edit("`Mencari Akun Gblk/Terhapus/Zombie...`")
        ...
        if del_u > 0:
            del_status = (
                f"`Menemukan` **{del_u}** `Akun Gblk/Terhapus/Zombie Dalam Grup Ini,"
