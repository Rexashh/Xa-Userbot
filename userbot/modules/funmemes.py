...
async def _(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit("Bii")
        await asyncio.sleep(0.3)
        await event.edit("Bii")
        await asyncio.sleep(0.2)
        await event.edit("Bii Cantik")
        await asyncio.sleep(0.5)
        await event.edit("Bii Imut")
        await asyncio.sleep(0.2)
        await event.edit("Bii Lucu")
        await asyncio.sleep(0.3)
        await event.edit("And")
        await asyncio.sleep(0.3)
        await event.edit("Bintang⭐")
        await asyncio.sleep(0.3)
        await event.edit("I LOVE YOU SO MUCH ♥️⭐♥️⭐")
...
async def _(event):
    ...
    if input_str == "hack":
        ...
        animation_chars = [
            ...
            "`Hacking... 84%\n█████████████████████▒▒▒▒ `",
            "`Hacking... 100%\n█████████HACKED███████████ `",
            f"`Targeted Account Hacked...\n\nBayar Goceng Ke {me.first_name} Atau belikan aku Xiboba 🍺 Untuk Menghapus Hack ini`",
        ]
...
async def _(event):
    if event.fwd_from:
        return
    deq = deque(list("Mau Kiss Dari aku Ga?"))
    for _ in range(48):
        await asyncio.sleep(0.1)
        await event.edit("".join(deq))
        deq.rotate(1)
