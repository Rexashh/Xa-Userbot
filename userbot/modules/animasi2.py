...
@Xa_cmd(pattern=r"^\.anjay$")
async def anjay(njay):
    await njay.edit(AENJEAYE)


@Xa_cmd(pattern=r"^\.(\w+)say (.*)")
...
@Xa_cmd(pattern=r"^\.(yes|no|maybe|decide)$")
...
@Xa_cmd(pattern=r"^\.cry$")
async def cry(e):
    await e.edit(choice(CRI))


@Xa_cmd(pattern=r"^\.insult$")
async def insult(e):
...
@Xa_cmd(pattern=r"^\.hello$")
async def hoi(hello):
    await hello.edit(choice(HELLOSTR))


@Xa_cmd(pattern=r"^\.owo(?: |$)(.*)")
async def focos(owo):
...
@Xa_cmd(pattern=r"^\.react$")
async def react_meme(react):
    await react.edit(choice(FACEREACTS))


@Xa_cmd(pattern=r"^\.shg$")
async def shrugger(shg):
    await shg.edit(choice(SHGS))


@Xa_cmd(pattern=r"^\.chase$")
async def police(chase):
    await chase.edit(choice(CHASE_STR))


@Xa_cmd(pattern=r"^\.run$")
async def runner_lol(run):
    await run.edit(choice(RUNS_STR))


@Xa_cmd(pattern=r"^\.metoo$")
...
@Xa_cmd(pattern=r"^\.10iq$")
async def iqless(e):
    await e.edit("♿")


@Xa_cmd(pattern=r"^\.fuck$")
async def iqbot(e):
    await e.edit("🖕🖕🖕🖕🖕🖕🖕🖕\n🖕🖕🖕🖕🖕🖕🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕🖕🖕🖕🖕\n🖕🖕🖕🖕🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕")


@Xa_cmd(pattern=r"^\.fakk$")
async def iqbott(e):
    await e.edit(".                       /¯ )")
    await e.edit(".                       /¯ )\n                      /¯  /")
    await e.edit(
...
@Xa_cmd(pattern=r"^\.bye$")
async def iqboot(e):
    await e.edit("Kek thx bye")


@Xa_cmd(pattern=r"^\.moon$")
...
@Xa_cmd(pattern=r"^\.poop$")
async def taco(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(r"{\__/}" "\n(●_●)" "\n( >💩 Want a poop,?")


@Xa_cmd(pattern=r"^\.paw$")
async def paw(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`(=ↀωↀ=)")
...
CMD_HELP.update(
    {
        ...
        "\nAnd Many More..."
        f"\n{cmd}nou | {cmd}bot | {cmd}gey | {cmd}gay | {cmd}tf | {cmd}paw | {cmd}poop | {cmd}nih | {cmd}ii ;"
