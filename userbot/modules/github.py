...
from userbot.utils import edit_delete, edit_or_reply, Xa_cmd, reply_id
...
CMD_HELP.update(
    {
        ...
        \n\n  ⌬  **𝙋𝙚𝙧𝙞𝙣𝙩𝙖𝙝 :** `{cmd}github` <username>\
        \n  ⌬  **𝙁𝙪𝙣𝙜𝙨𝙞 : **Menampilkan informasi tentang user di GitHub dari username yang diberikan\
    "
    }
)
