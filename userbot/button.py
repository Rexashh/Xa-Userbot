...
from userbot.utils import edit_delete, Xa_cmd, reply_id
...
CMD_HELP.update(
    {
        ...
        \n  ⌬  **Examples : **`{cmd}button test [Xvideos]<buttonurl:https://www.xvideos.com> [Channel]<buttonurl:https://t.me/tirexgugel:same> [Support]<buttonurl:https://t.me/rexaprivateroom>`\
    "
    }
)
