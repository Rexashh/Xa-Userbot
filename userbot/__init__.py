...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL", "https://github.com/RexAshh/Xa-Userbot.git"
)

# Custom Name Sticker Pack
S_PACK_NAME = os.environ.get("S_PACK_NAME", "Sticker Pack by @tirexgugel")
...
# Default .alive name
ALIVE_NAME = os.environ.get("ALIVE_NAME", "Xa")
...
# Default .alive logo
ALIVE_LOGO = (
    os.environ.get("ALIVE_LOGO") or "https://telegra.ph/file/edafa1a01945352dd7f4f.jpg"
)

INLINE_PIC = (
    os.environ.get("INLINE_PIC") or "https://telegra.ph/file/751e99753b10d5cec6b33.jpg"
)
...
with bot:
    try:
        ...
        async def inline_handler(event):
            ...
            result = None
            query = event.text
            if event.query.user_id == uid and query.startswith("@rexaprivateroom"):
